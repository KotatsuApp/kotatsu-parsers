...
//}
//
//public fun HttpResponse.copy(): Response = newBuilder()
//	.body(peekBody(Long.MAX_VALUE))
//	.build()
//
//public fun HttpResponse.Builder.setHeader(name: String, value: String?): Response.Builder = if (value == null) {
//	removeHeader(name)
//} else {
//	header(name, value)
//}
//
//public inline fun HttpResponse.map(mapper: (ResponseBody) -> ResponseBody): Response {
//	contract {
