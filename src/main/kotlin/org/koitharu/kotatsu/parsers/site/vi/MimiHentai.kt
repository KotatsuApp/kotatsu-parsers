...
internal class MimiHentai(context: MangaLoaderContext) :
	...
	override fun intercept(chain: Interceptor.Chain): Response {
		...
		return context.redrawImageResponse(response) { bitmap ->
			...
			runBlocking {
                val fullGt = context.evaluateJs("""
                    ((Ω)=>{const Φ=String.fromCharCode,Ψ=parseInt,ℵ=Array.from,Ξ=Math.PI,Δ=new TextEncoder(),Λ=new TextDecoder(),Θ=Uint8Array,Σ=[49,46,50,51,56,55,50,57,49,51,49,48,50,57,51,56,44,49,46,50,56,55,54,55,57,49,51,49,50,51,52,52,56,44,49,46,51,57,49,51,55,56,49,57,50,51,48,48,51,57,49,44,50,46,51,57,49,51,55,56,49,57,50,53,48,48,51,57,49,44,51,46,51,57,49,51,55,56,49,57,49,50,51,48,51,57,49,44,52,46,51,57,49,51,55,51,50,49,48,57,54,53,48,57,49,44,50,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,53,46,49,57,50,56,52,55,51,54,50,56,52,55,50,57,49,44,51,46,57,52,55,51,56,50,57,49,55,52,56,51,57,50,49,44,49,46,56,52,55,51,57,50,56,52,55,50,57,49,56,52,55,44,54,46,50,57,51,56,52,55,50,57,49,56,52,55,51,56,50,44,52,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,50,46,51,57,52,56,50,55,51,57,52,56,50,55,51,57,52,44,55,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,51,46,56,50,55,51,57,52,56,50,55,51,57,52,56,50,55,44,49,46,57,52,55,51,56,50,57,52,55,51,56,50,57,52,55,44,56,46,50,57,51,56,52,55,50,57,49,56,52,55,51,56,50,44,53,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,50,46,55,51,56,52,55,50,57,51,56,52,55,50,57,51,56,44,57,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,52,46,50,57,51,56,52,55,50,57,49,56,52,55,51,56,50,44,54,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,51,46,52,57,50,56,52,55,50,57,49,56,52,55,51,57,50,44,49,46,55,51,57,52,56,50,55,51,56,52,55,50,57,51,56,44,55,46,50,57,51,56,52,55,50,57,49,56,52,55,51,56,50,44,53,46,51,57,52,56,50,55,51,57,52,56,50,55,51,57,52,44,50,46,56,52,55,51,57,49,56,52,55,51,57,50,56,52,55,44,56,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,52,46,55,51,56,52,55,50,57,51,56,52,55,50,57,51,56,44,54,46,50,57,51,56,52,55,51,57,49,56,52,55,51,56,50,44,51,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,49,46,52,57,50,56,52,55,50,57,49,56,52,55,51,57,50,44,57,46,50,57,51,56,52,55,50,57,49,56,52,55,51,56,50,44,53,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,50,46,49,50,48,51,56,49,48,50,57,52,55,53,54,48,50,44,55,46,51,57,48,52,56,49,50,54,52,55,50,54,49,57,52,44,52,46,50,57,51,48,49,50,52,54,50,52,49,57,52,49,50,44,54,46,51,48,49,52,49,50,55,48,52,49,55,48,50,57,52,44,51,46,55,51,56,52,55,50,57,51,56,52,55,50,57,51,56,44,49,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,56,46,50,49,51,57,48,49,50,56,48,49,52,57,50,49,48,44,53,46,51,57,52,56,50,55,51,57,52,56,50,55,51,57,52,44,50,46,50,48,49,51,56,49,48,50,50,48,51,56,57,53,54,44,57,46,51,49,48,49,50,57,48,51,49,50,56,52,54,57,56,44,49,48,46,51,50,49,51,49,48,51,49,50,56,52,54,57,56,44,49,46,49,51,48,55,49,50,48,51,57,56,50,48,49,52,55];const ζ=Φ(...Σ).split(',').map(parseFloat);const η=Ψ(Ω.slice(-2),10);const θ=(Ξ*(η<=45&&η>=0?ζ[η]:1.2309829040349309)).toString();const ι=Ω.slice(0,-2);const κ=new Θ(ι.length/2);for(let λ=0;λ<ι.length;λ+=2)κ[λ/2]=Ψ(ι.substring(λ,λ+2),16);const μ=Δ.encode(θ);const ν=new Θ(κ.length);for(let ξ=0;ξ<κ.length;ξ++)ν[ξ]=κ[ξ]^μ[ξ%μ.length];return Λ.decode(ν)})("$gt")
                """".trimIndent(), fragment.substringBefore(GT)) ?: throw Exception("Đã xảy ra lỗi trong quá trình giải nén dữ liệu")
				extractMetadata(bitmap, fullGt)
			}
		}
	}
