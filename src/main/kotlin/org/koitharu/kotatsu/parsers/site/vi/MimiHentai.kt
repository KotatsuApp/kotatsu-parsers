...
internal class MimiHentai(context: MangaLoaderContext) :
	...
	override fun intercept(chain: Interceptor.Chain): Response {
		...
		return context.redrawImageResponse(response) { bitmap ->
			...
			runBlocking {
				extractMetadata(bitmap, ori, fragment.substringBefore(GT))
			}
		}
	}

	private suspend fun extractMetadata(bitmap: Bitmap, ori: String, url: String): Bitmap {
        val gt = context.evaluateJs("""
            ((a) => {
              const b = String.fromCharCode,
                    ...
                    g = new TextDecoder(),
                    h = Uint8Array,
                    i = [49,46,50,51,56,55,50,57,49,51,49,48,50,57,51,56,44,49,46,50,56,55,54,55,57,49,51,49,50,51,52,52,56,44,49,46,51,57,49,51,55,56,49,57,50,51,48,48,51,57,49,44,50,46,51,57,49,51,55,56,49,57,50,53,48,48,51,57,49,44,51,46,51,57,49,51,55,56,49,57,49,50,51,48,51,57,49,44,52,46,51,57,49,51,55,51,50,49,48,57,54,53,48,57,49,44,50,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,53,46,49,57,50,56,52,55,51,54,50,56,52,55,50,57,49,44,51,46,57,52,55,51,56,50,57,49,55,52,56,51,57,50,49,44,49,46,56,52,55,51,57,50,56,52,55,50,57,49,56,52,55,44,54,46,50,57,51,56,52,55,50,57,49,56,52,55,51,56,50,44,52,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,50,46,51,57,52,56,50,55,51,57,52,56,50,55,51,57,52,44,55,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,51,46,56,50,55,51,57,52,56,50,55,51,57,52,56,50,55,44,49,46,57,52,55,51,56,50,57,52,55,51,56,50,57,52,55,44,56,46,50,57,51,56,52,55,50,57,49,56,52,55,51,56,50,44,53,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,50,46,55,51,56,52,55,50,57,51,56,52,55,50,57,51,56,44,57,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,52,46,50,57,51,56,52,55,50,57,49,56,52,55,51,56,50,44,54,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,51,46,52,57,50,56,52,55,50,57,49,56,52,55,51,57,50,44,49,46,55,51,57,52,56,50,55,51,56,52,55,50,57,51,56,44,55,46,50,57,51,56,52,55,50,57,49,56,52,55,51,56,50,44,53,46,51,57,52,56,50,55,51,57,52,56,50,55,51,57,52,44,50,46,56,52,55,51,57,49,56,52,55,51,57,50,56,52,55,44,56,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,52,46,55,51,56,52,55,50,57,51,56,52,55,50,57,51,56,44,54,46,50,57,51,56,52,55,51,57,49,56,52,55,51,56,50,44,51,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,49,46,52,57,50,56,52,55,50,57,49,56,52,55,51,57,50,44,57,46,50,57,51,56,52,55,50,57,49,56,52,55,51,56,50,44,53,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,50,46,49,50,48,51,56,49,48,50,57,52,55,53,54,48,50,44,55,46,51,57,48,52,56,49,50,54,52,55,50,54,49,57,52,44,52,46,50,57,51,48,49,50,52,54,50,52,49,57,52,49,50,44,54,46,51,48,49,52,49,50,55,48,52,49,55,48,50,57,52,44,51,46,55,51,56,52,55,50,57,51,56,52,55,50,57,51,56,44,49,46,56,52,55,50,57,49,56,52,55,51,57,50,56,52,55,44,56,46,50,49,51,57,48,49,50,56,48,49,52,57,50,49,48,44,53,46,51,57,52,56,50,55,51,57,52,56,50,55,51,57,52,44,50,46,50,48,49,51,56,49,48,50,50,48,51,56,57,53,54,44,57,46,51,49,48,49,50,57,48,51,49,50,56,52,54,57,56,44,49,48,46,51,50,49,51,49,48,51,49,50,56,52,54,57,56,44,49,46,49,51,48,55,49,50,48,51,57,56,50,48,49,52,55];

              const j = b(...i).split(',').map(parseFloat);
              const k = c(a.slice(-2), 10);
              const l = (e * (k <= 45 && k >= 0 ? j[k] : 1.2309829040349309)).toString();
              const m = a.slice(0, -2);
              const n = new h(m.length / 2);
              for (let o = 0; o < m.length; o += 2)
                n[o / 2] = c(m.substring(o, o + 2), 16);
              const p = f.encode(l);
              const q = new h(n.length);
              for (let r = 0; r < n.length; r++)
                q[r] = n[r] ^ p[r % p.length];
              return g.decode(q);
            })("$ori")
        """.trimIndent(), url) ?: throw Exception("Đã xảy ra lỗi trong quá trình giải nén dữ liệu")
